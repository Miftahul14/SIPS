...
urlpatterns = [
    ...
    path('sanksi_pelanggaran/',views.sanksi_pelanggaran, name='sanksi_pelanggaran'), 
    path('tambah_sanksi/',views.tambah_sanksi, name='tambah_sanksi'), 
    path('edit_sanksi/<int:id>/',views.edit_sanksi, name='edit_sanksi'), 
    path('hapus_sanksi/<int:id>/',views.hapus_sanksi, name='hapus_sanksi'), 
